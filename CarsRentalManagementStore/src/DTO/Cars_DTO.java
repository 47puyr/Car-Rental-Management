...
public class Cars_DTO {
    ...
    public Cars_DTO(int id, int brand, String model, String fuel, String color, String _class_, int passengers, String gearbox, int price, String air_cond, String airbag, String sunroof, String heated_seats, String nav_sys, String bluetooth, String elec_window, String gps) {
        this.id = id;
        this.brand = brand;
        this.model = model;
        this.fuel = fuel;
