...
public class Booking_DTO {
    ...
    public Booking_DTO(int id, int car_id, int customer_id, String pickup_city, String pickup_address, String pickup_date, String pickup_time, String dropoff_city, String dropoff_address, String dropoff_date, String dropoff_time, int total_price) {
        this.id = id;
        this.car_id = car_id;
