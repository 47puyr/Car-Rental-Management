...
public class Users_GUI extends javax.swing.JFrame {
    ...
    public String selectImage()
    {
        ...
        fileChooser.setCurrentDirectory (new File("D:\\Java\\DoAnJava\\CarsRentalManagementStore\\src\\images\\user"));
    ...
    private void jTable_usersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_usersMouseClicked
        ...
        int id = Integer.valueOf(jTable_users.getValueAt(index, 0).toString());

        Users_DTO selected_user = null;
        try {
            selected_user = userBUS.getUserById(id);
        ...
        if (selected_user != null) {
            ...
            jPasswordField_password.setText(selected_user.getPassword());
    ...
    private void jButton_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_addActionPerformed
        ...
        if (verify()) {
            try {
                userBUS.addUser(id, fullname, username, password, user_type, picture, phone, email);
            } catch (SQLException ex) {
    ...
    private void jButton_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_updateActionPerformed
        ...
        try {
            if (!jLabel_imagePath.getText().trim().isEmpty()) {
                ...
                try {
                    picture = userBUS.getUserById(id).getPicture();
                } catch (SQLException ex) {
                    Logger.getLogger(Users_GUI.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if (verify()) {
            try {
                userBUS.updateUser(id, fullname, username, password, user_type, picture, phone, email);
            } catch (SQLException ex) {
