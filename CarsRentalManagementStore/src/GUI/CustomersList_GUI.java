...
public class CustomersList_GUI extends javax.swing.JFrame {
    ...
    private void jButton_selectcustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_selectcustomerActionPerformed
        ...
        try {
            ...
            String id = jTable_customerlist.getValueAt(index, 0).toString();
            String fullname = jTable_customerlist.getValueAt(index, 1).toString();

            //set the customer id & name in the book a car form
            if(originaform.equals("add")) { BookCars_GUI.displayCustomer(id, fullname); }
            else if(originaform.equals("edit")) { Booking_Edit_Remove_GUI.displayCustomer(id, fullname); }
            //Close this form
            this.dispose();
        } catch (Exception e) 
        {
