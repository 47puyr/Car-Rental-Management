...
public class Brands_GUI extends javax.swing.JFrame {
    ...
    public String selectImage()
    {
        ...
        fileChooser.setCurrentDirectory (new File("D:\\Java\\DoAnJava\\CarsRentalManagementStore\\src\\images\\brand"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(93, 93, 93)
                        .addComponent(jButton_refresh, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(85, 85, 85)
                        .addComponent(jButton_clear, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_addActionPerformed
        ...
        if (verify()) {
            ...
            try {
                brandsBUS.addBrand(id, name, logo);
    ...
    private void jButton_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_updateActionPerformed
        ...
        try {
            if (!jLabel_imagePath.getText().trim().isEmpty()) {
                ...
                try {
                    // If no new image is selected, use the current logo
                    logo = brandsBUS.getBrandById(id).getLogo();
                } catch (SQLException ex) {
                    Logger.getLogger(Brands_GUI.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        if (verify()) {
            ...
            boolean nameExists = brands_list.stream().anyMatch(brand -> brand.getName().equalsIgnoreCase(name) && brand.getId() != id);
            if (nameExists) {
                JOptionPane.showMessageDialog(null, "Brand name already exists!", "Duplicate Brand", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            try {
                brandsBUS.updateBrand(id, name, logo);        
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "Use a Smaller Size Image", "Brand Logo", 2);
            }
        }
    ...
    private void jTable_brandsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_brandsMouseClicked
        ...
        if (index >= 0) {
            ...
            // Retrieve the brand information from the list
            ...
            if (selectedBrand != null) {
                // Update the UI components with the brand information
                //clear the jlabel image path
                jLabel_imagePath.setText("");
                jSpinner_id.setValue(selectedBrand.getId());
